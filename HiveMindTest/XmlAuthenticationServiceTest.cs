...
{
    [TestClass]
    public class XmlAuthenticationServiceTest
    {
        private XmlAuthenticationService service = new XmlAuthenticationService(@"D:\Programs\C# and .NET\Doubt\HiveMind\HiveMindTest\dependencies\AuthenticationData.xml");
